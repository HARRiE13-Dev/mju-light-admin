...
declare module 'vue-router/auto-routes' {
  ...
  export interface RouteNamedMap {
    ...
    'no-existence': RouteRecordInfo<'no-existence', '/no-existence', Record<never, never>, Record<never, never>>,
    'register': RouteRecordInfo<'register', '/register', Record<never, never>, Record<never, never>>,
    'room-view': RouteRecordInfo<'room-view', '/room-view', Record<never, never>, Record<never, never>>,
